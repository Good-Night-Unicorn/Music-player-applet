<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="会员卡号" prop="huiyuankahao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会员类型" prop="huiyuanleixing">
          <el-input v-model="ruleForm.huiyuanleixing" 
              placeholder="会员类型" clearable  :readonly="ro.huiyuanleixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会员类型" prop="huiyuanleixing">
              <el-input v-model="ruleForm.huiyuanleixing" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.daoqishijian" label="到期时间" prop="daoqishijian">
              <el-input v-model="ruleForm.daoqishijian" 
                placeholder="到期时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
