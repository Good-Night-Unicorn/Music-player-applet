<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="歌曲分类" prop="gequfenlei">
        ...
        <div v-else>
          <el-form-item class="input" label="歌曲分类" prop="gequfenlei">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="专辑名称" prop="zhuanjimingcheng">
          <el-input v-model="ruleForm.zhuanjimingcheng" 
              placeholder="专辑名称" clearable  :readonly="ro.zhuanjimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="专辑名称" prop="zhuanjimingcheng">
              <el-input v-model="ruleForm.zhuanjimingcheng" 
                placeholder="专辑名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.geci = this.ruleForm.geci.replace(reg,'../../../ssm28wqy/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
