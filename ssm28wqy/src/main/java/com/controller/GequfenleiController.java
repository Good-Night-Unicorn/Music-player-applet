...
public class GequfenleiController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,GequfenleiEntity gequfenlei, HttpServletRequest request){
        EntityWrapper<GequfenleiEntity> ew = new EntityWrapper<GequfenleiEntity>();
		PageUtils page = gequfenleiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, gequfenlei), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<GequfenleiEntity> wrapper = new EntityWrapper<GequfenleiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = gequfenleiService.selectCount(wrapper);
